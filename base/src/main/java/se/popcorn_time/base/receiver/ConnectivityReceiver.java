...
public class ConnectivityReceiver extends BroadcastReceiver {
    ...
    public static final boolean DEFAULT_ONLY_WIFI_CONNECTION = false;
    ...
    public static void checkWifiConnection(Context context) {
        ...
        if (isConnected) {
            if (Prefs.getSettingsPrefs().get(SettingsPrefs.ONLY_WIFI_CONNECTION, DEFAULT_ONLY_WIFI_CONNECTION)) {
