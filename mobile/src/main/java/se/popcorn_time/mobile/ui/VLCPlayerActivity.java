...
public class VLCPlayerActivity extends PlayerBaseActivity implements IVLCVout.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        libVLC = new LibVLC(VLCOptions.getLibOptions());
    ...
    private void startPlayback() {
        ...
        vlcVout.setCallback(VLCPlayerActivity.this);
        vlcVout.attachViews();
        ...
        VLCOptions.setMediaOptions(media, 0, Prefs.getSettingsPrefs().get(SettingsPrefs.HARDWARE_ACCELERATION, VLCOptions.HW_ACCELERATION_AUTOMATIC));
    ...
    private void initAudioTracks() {
        Map<Integer, String> audioTracks = mediaPlayer.getAudioTrackDescription();
        int currentAudioTrack = mediaPlayer.getAudioTrack();
        List<AudioItem> audioItems = new ArrayList<>();
        AudioItem currentAudioItem = null;
        for (int key : audioTracks.keySet()) {
            AudioItem audioItem = new AudioItem(key, audioTracks.get(key)) {
                @Override
